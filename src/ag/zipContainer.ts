import {decToHex, utf8_encode} from '../utils/underscore.ts';
...
export class ZipContainer {
    ...
    /**
     * Adds a folder to the zip file stream.
     *
     * @param {string} path
     * @private
     */
    ...
    /**
     * Adds a file to the zip file stream.
     *
     * @param {string} path
    ...
    /**
     * Returns the zip file stream, and clears the files and folders added to the stream.
     * IMPORTANT
     *
    ...
    /**
     * Builds the zip file stream based on all the files and folders added to the stream.
     *
     * @param {boolean} compressOutput
    ...
    /**
     * Converts the content to base64 if it is not already base64 encoded.
     *
     * @param {string} content
     * @param {boolean} isBase64
     * @returns {{size: number, content: string}}
     * @private
     */
